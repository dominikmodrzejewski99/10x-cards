...
@Component({
  ...
  styles: [`
    ...
    .auth-success i { font-size: 2rem; color: var(--app-success); margin-bottom: 0.75rem; }
    .auth-success p { margin: 0.25rem 0; font-size: 0.9rem; }
    .auth-success__hint { font-size: 0.8rem; color: var(--app-text-secondary); margin-top: 0.5rem; }
