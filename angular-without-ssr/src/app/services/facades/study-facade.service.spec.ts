...
import { SpacedRepetitionService } from '../domain/spaced-repetition.service';
...
describe('StudyFacadeService', () => {
  ...
  const mockSets: FlashcardSetDTO[] = [
    ...
    { id: 2, user_id: 'u1', name: 'Set B', description: null, tags: [], is_public: false, copy_count: 0, published_at: null, original_author_id: 'u1', source_set_id: null, created_at: '', updated_at: '' }
  ];
