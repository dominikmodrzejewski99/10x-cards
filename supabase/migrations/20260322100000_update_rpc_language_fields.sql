-- Update RPC functions to include front_language and back_language columns
...
BEGIN
  ...
  WITH inserted_flashcard AS (
    INSERT INTO public.flashcards (front, back, source, user_id, generation_id, set_id, front_language, back_language, created_at, updated_at)
    VALUES (
